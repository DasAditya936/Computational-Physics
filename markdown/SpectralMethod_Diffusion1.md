...
3. Dispersion, i.e. broadening of the wave packet is also apparent(take the temporal derivative also, from there we get $\iota \omega =-Dk^2$, meaning that different wavelengths have different $\omega$ $\Longrightarrow$ wave packet broadens, but again the $Re(\omega)$ is zero for any given $k$, but $|\omega|$ is different for different $k$. It is the matter of POV here, discussed in the previous lecture: 

   [Fourier Transform and FFT]: file:///home/adityadas/codingProjects/MATLAB_CodeScripts/Topics/04_SpectralScheme_PDEs/notes/FourierTrans_SpectralMeth.html
...
![figure_0.png](/home/adityadas/codingProjects/MATLAB_CodeScripts/Animations/SpectralMethod_Diffusion_media/figure_0.png)
...
![figure_1.png](/home/adityadas/codingProjects/MATLAB_CodeScripts/Animations/SpectralMethod_Diffusion_media/figure_1.png)

![image_0.gif](/home/adityadas/codingProjects/MATLAB_CodeScripts/Animations/SpectralMethod_Diffusion_media/image_0.gif)
